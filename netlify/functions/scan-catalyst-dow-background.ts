// scan-catalyst-dow-background — 15-min background worker.
//
...
const UNIVERSE: CatalystUniverseKey = 'dow';
...
export const handler: Handler = async (event) => {
  ...
  const log = logger.child({ fn: 'scan-catalyst-dow', universe: UNIVERSE });
