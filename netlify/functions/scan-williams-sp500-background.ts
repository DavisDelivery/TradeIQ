// scan-williams-sp500-background — 15-min background worker.
//
...
const UNIVERSE: WilliamsUniverseKey = 'sp500';
...
export const handler: Handler = async (event) => {
  ...
  const log = logger.child({ fn: 'scan-williams-sp500', universe: UNIVERSE });
