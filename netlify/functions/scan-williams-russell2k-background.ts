// scan-williams-russell2k-background — 15-min background worker.
//
...
const UNIVERSE: WilliamsUniverseKey = 'russell2k';
...
export const handler: Handler = async (event) => {
  ...
  const log = logger.child({ fn: 'scan-williams-russell2k', universe: UNIVERSE });
