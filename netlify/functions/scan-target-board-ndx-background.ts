// scan-target-board-ndx-background — 15-min background worker.
//
...
const UNIVERSE: TargetUniverseKey = 'ndx';
...
export const handler: Handler = async (event) => {
  ...
  const log = logger.child({ fn: 'scan-target-board-ndx', universe: UNIVERSE });
