...
| 4b-2 | Backtest run launcher | pending | — | — | UI launch via background function. Form + progress indicator. Prophet-only initially. Deferred from 4b-1 because background-function architecture warrants separate scoping. |
