...
| 2 | Refactor foundation (schemas + monolith split + TanStack Query) | done | 0.11.0-alpha | 2026-05-08 | Zod at 5 provider boundaries (10 fetch sites + 5 Quiver datasets); App.jsx 2965 -> 336 lines; 13 hooks + provider wrap; 5 board views wired (Williams/Lynch/Catalyst/Insider/TargetBoard); 127 tests (62 baseline + 54 schema + 11 hook); +12kB gzipped under 820kB budget. ProphetView and 4 non-board view wires deferred to follow-up. |
